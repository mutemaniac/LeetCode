...
unsigned char fromfrom(int **matrix, int matrixRowSize, int matrixColSize,
                   unsigned char **map, int x, int y, int from,
                   int *returnSize)
{
    //Have computed.
    if (!(map[x][y]&0x3))
